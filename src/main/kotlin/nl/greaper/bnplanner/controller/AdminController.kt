...
class AdminController(
    ...
    ): FixService.SyncInfo = fixService.syncAllUsers(osuApiToken)
    ...
    ): FixService.SyncInfo = fixService.syncUsers(osuApiToken, users, force ?: false)
